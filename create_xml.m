%%
%????????????voc2007??????????xml??????
%txt????????????????000002.jpg dog 44 28 132 121
%??????????????????????????????????????????????????
%????????????????????????????????????????????????????
...
clear;
%????????????????????
imgpath='E:\my_document\data\train_data_png\all_png_image\';%??????????????
txtpath='E:\my_document\data\train_data_png\data_box_01.txt';%txt????
xmlpath_new='E:\my_document\data\train_data_png\Annotations_01\';%????????xml??????????
foldername='VOC2007';%xml??folder??????
...
%       pause(0.1);
        ...
        if strcmp(str{1},lastname)%????????????????????????object
           ...
           node=Createnode.createElement('name');
           node.appendChild(Createnode.createTextNode(sprintf('juntawu')));
           owner_node.appendChild(node);
